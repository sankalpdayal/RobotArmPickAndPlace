...
`def create_transformation_matrix(alpha, a, d, q):<br />
	trans_mat = Matrix([[ 				cos(q),				-sin(q),			0,			    a],<br />
						[ 	 sin(q)*cos(alpha),	  cos(q)*cos(alpha),  -sin(alpha),	-sin(alpha)*d],<br />
						[ 	 sin(q)*sin(alpha),	  cos(q)*sin(alpha),   cos(alpha),	 cos(alpha)*d],<br />
						[ 					 0,					  0,			0,			    1]])<br />
	return trans_mat`
